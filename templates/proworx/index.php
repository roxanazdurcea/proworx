...
$doc->addScriptVersion($this->baseurl . '/templates/' . $this->template . '/js/proworx.js');
	...
	<footer class="footer" role="contentinfo">
		<div class="container-fluid<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
          ...
          <div class="copyright">
			...
			<p>
              &copy; <?php echo date('Y'); ?> <?php echo $sitename; ?> | Designed by <a href="http://bmbc.co/index.php/en/" target="_blanck">BMBC Premium Solutions </a>
			</p>
            </div>
          </div>
		</div>
